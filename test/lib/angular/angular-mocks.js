 ...
 *
 * <pre>
 *   siteTrackrDev = angular.module('siteTrackrDev', ['siteTrackr', 'ngMockE2E']);
 *   siteTrackrDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('siteTrackrlicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('siteTrackr', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('siteTrackrlicationModule'));
   *
   *
